const en: Record<string, string> = {
  ...
  ctaSub: "Windows installer · 0.4.71 · ~95 MB",
  ...
  q2a: "Yes. Everyone uses the same version (currently 0.4.71). The host starts a deck and shares the six-character session code.",
  q3: "How does it work?",
...
const nl: Record<string, string> = {
  ...
  q2a: "Ja. Iedereen dezelfde versie (nu 0.4.71). De host start een deck en deelt de sessiecode van zes tekens.",
  q3: "Hoe werkt het?",
