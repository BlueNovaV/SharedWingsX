const en: Record<string, string> = {
  ...
  navApp: "The app",
  navFaq: "Questions",
  eyebrow: "MSFS 2020 / 2024",
  heroTitle: "Shared cockpit for MSFS",
  heroLede:
    "Captain on one PC, first officer on the other. Same aircraft, same parking. Host starts a deck and sends the six-character code.",
  heroWhisper: "Zelfde stoel. Twee PCs.",
  cta: "Download",
  cta2: "Download SharedWingsX",
  ctaSub: "Windows installer · 0.4.72 · ~95 MB",
  ...
  sdDeck: "Flight deck",
  sdLeft: "Left · flies",
  sdRight: "Right · radios",
  sdJump: "Watch only",
  sdHand: "Give / take flying on the person.",
  airTitle: "PMDG, Fenix, Asobo, stock",
  airCopy:
    "Yoke, thrust, gear, flaps, radios and ATC sync. Payware CDU, EFB and FMS are not a second identical box. Dedicated packs for C172 and 787-10.",
  airUni: "Universal",
  ...
  howTitle: "Setup",
  s1t: "App",
  s1: "Run SharedWingsX-Setup.exe. Presence is copied into Community.",
  s2t: "Sim",
  s2: "Same aircraft, same spawn, same weather. Multiplayer off. Crash physics off.",
  s3t: "Code",
  s3: "Host clicks Start deck. The other pilot pastes the six-character code and clicks Connect.",
  s4t: "Crew",
  s4: "Captain left, FO right. Hand over flying on the person.",
  sHint: "Run Setup. Presence is copied into Community. No extra runtimes.",
  appTitle: "The Windows app",
  appCopy:
    "Host and join on one window. Same build on every PC.",
  faqTitle: "Questions",
  endTitle: "Get the installer",
  endCopy: "Same Setup on both PCs. No account.",
  ...
  q2a: "Yes. Everyone uses the same version (currently 0.4.72). The host starts a deck and shares the six-character session code.",
  q3: "How does it work?",
...
const nl: Record<string, string> = {
  ...
  navFaq: "FAQ",
  eyebrow: "MSFS 2020 / 2024",
  heroTitle: "Shared cockpit voor MSFS",
  heroLede:
    "Captain op de ene pc, first officer op de andere. Zelfde toestel, zelfde parkeerplaats. De host start een deck en stuurt de code van zes tekens.",
  cta: "Download",
  cta2: "Download SharedWingsX",
  ctaSub: "Windows-installer · 0.4.72 · ~95 MB",
  ...
  sdDeck: "Flight deck",
  sdLeft: "Links · vliegt",
  sdRight: "Rechts · radio’s",
  sdJump: "Alleen meekijken",
  sdHand: "Give / take op de persoon.",
  airTitle: "PMDG, Fenix, Asobo, stock",
  airCopy:
    "Stuurvlakken, gassen, gear, flaps, radio’s en ATC synchen. Payware-CDU, EFB en FMS zijn geen tweede identiek scherm. Dedicated packs voor C172 en 787-10.",
  airUni: "Universeel",
  ...
  howTitle: "Setup",
  s1t: "App",
  s1: "SharedWingsX-Setup.exe. Presence gaat naar Community.",
  s2t: "Sim",
  s2: "Zelfde toestel, spawn en weer. Multiplayer uit. Crash physics uit.",
  s3t: "Code",
  s3: "De host klikt Start deck. De ander plakt de code van zes tekens en klikt Connect.",
  s4t: "Crew",
  s4: "Captain links, FO rechts. Besturing geef je op de persoon.",
  sHint: "Setup draaien. Presence gaat naar Community. Geen extra runtimes.",
  appTitle: "De Windows-app",
  appCopy:
    "Host en join op één venster. Iedereen dezelfde build.",
  faqTitle: "Vragen",
  endTitle: "Installer ophalen",
  endCopy: "Zelfde Setup op beide pc’s. Geen account.",
  ...
  q2a: "Ja. Iedereen dezelfde versie (nu 0.4.72). De host start een deck en deelt de sessiecode van zes tekens.",
  q3: "Hoe werkt het?",
