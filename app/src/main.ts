...
function header(): string {
  ...
  return `
    <header class="bar">
      <div class="bar-left">
        <p class="brand"><img src="./brand/logo.png" alt="" /><span>SharedWingsX</span> <span class="ver">${escapeHtml(update?.current || "0.4.40")}</span></p>
      </div>
      ${flightBarHtml()}
      <div class="bar-right">
    ...
    <div class="frame board-frame">
      ...
      <div class="board">
        ...
        <section class="card" data-card="settings">
          ...
          <p class="hint">Version ${escapeHtml(update?.current || "0.4.40")}${
            !update
              ? " · checking…"
              : update.outdated
